...
<body class="sticky-header">
							...
							<div class="panel-body">
								<div id="search-condition" class="search-condition row">
									...
									<div class="col-md-6" style="padding-left:0">
										...
										<div class="col-md-4">
										<select class="form-control" name="inviterNumOrderBy" id="inviterNumOrderBy">
											<option value="0" checked="checked">邀请人数降序</option>
											<option value="1">邀请人数升序</option>
										</select>
										</div>
									</div>
								</div>
	...
	<script src="js/inviterNumList.js"></script>
	<script type="text/javascript">
