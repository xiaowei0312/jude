									...
									<div class="clearfix">
										<div class="btn-group">
											<a href="#modal_add" data-toggle="modal"><button type="button" id="addMallBtn"
														class="btn btn-primary">添加新商铺</button></a>
											</button>
										</div>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											<section class="panel">
												<header class="panel-heading"> 修改商铺信息 </header>
												<div class="panel-body">
													<form class="form-horizontal" role="form"
														id="modalForm">
														<div class="form-group">
															<label for="commodityName_editModal"
																class="col-lg-2 col-sm-2 control-label">商铺名称</label>
															<div class="col-lg-10">
																<input type="hidden" class="form-control" name="id"
																	id="id" placeholder="商铺ID">
																<input type="text" class="form-control"
																	name="mallName" id="mallName"
																	placeholder="商铺名称">
														...
														<div class="form-group">
															<label for="commoditySeq_editModal"
																class="col-lg-2 col-sm-2 control-label">联系人</label>
															<div class="col-lg-10">
																<input type="text" class="form-control"
																	name="mallLinkMan" id="mallLinkMan"
																	placeholder="联系人">
														...
														<div class="form-group">
															<label for="commoditySeq_editModal"
																class="col-lg-2 col-sm-2 control-label">联系电话</label>
															<div class="col-lg-10">
																<input type="text" class="form-control"
																	name="mallPhone" id="mallPhone"
																	placeholder="联系电话">
																<!-- <p class="help-block">联系电话代表该商铺的常用联系电话.</p> -->
															</div>
														</div>
														<div class="form-group">
															<label for="commoditySeq_editModal"
																class="col-lg-2 col-sm-2 control-label">商铺位置</label>
															<div class="col-lg-10">
																<input type="text" class="form-control"
																	name="mallAddress" id="mallAddress"
																	placeholder="商铺位置">
														...
														<div class="form-group">
															<label for="commoditySeq_editModal"
																class="col-lg-2 col-sm-2 control-label">经玮度</label>
															<div class="col-lg-3">
																<input type="text" class="form-control"
																	name="mallPos_lnt" id="mallPos_lnt"
																	placeholder="经度">
															</div>
															<div class="col-lg-3">
																<input type="text" class="form-control"
																	name="mallPos_lat" id="mallPos_lat"
																	placeholder="纬度">
															</div>
														...
														<div class="form-group">
															<label for="commoditySeq_editModal"
																class="col-lg-2 col-sm-2 control-label">平台商家</label>
															<div class="col-lg-10">
																<input type="text" class="form-control"
																	name="user.keywords" id="userKeyWords"
																	placeholder="商家用户名或者电话">
														...
														<div class="form-group">
															...
															<div class="col-lg-10">
																<select name="mallType.id" class="form-control"
																	id="mallTypeId">
