...
<body class="sticky-header">
									...
									<div class="clearfix">
										<div class="btn-group">
											<a href="#modal_add" data-toggle="modal"><button type="button" id="addMallBtn"
														class="btn btn-primary">添加新权限</button></a>
											</button>
										</div>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											<section class="panel">
												<header class="panel-heading"> 新增权限 </header>
												<div class="panel-body">
													<form class="form-horizontal" role="form"
														id="modalForm">
														<div class="form-group">
															<label for="commodityName_editModal"
																class="col-lg-2 col-sm-2 control-label">权限名</label>
															<div class="col-lg-10">
							...
							<div aria-hidden="true" aria-labelledby="myModalLabel"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											<section class="panel">
												<header class="panel-heading"> 修改权限信息 </header>
												<div class="panel-body">
													<form class="form-horizontal" role="form"
														id="modalForm">
														<div class="form-group">
	...
	<script type="text/javascript" src="js/permList.js"></script>
	<!-- END JAVASCRIPTS -->
