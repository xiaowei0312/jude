									...
									<div class="clearfix">
										<div class="btn-group">
											<a href="#modal_add" data-toggle="modal"><button type="button" id="addMallBtn"
														class="btn btn-primary">添加新操作</button></a>
											</button>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group col-md-6">
												<select class="form-control" name="roleSelect"
													id="typeSelect">
													<option value="0" checked="checked">序号升序</option>
													<option value="1" checked="checked">序号降序</option>
												</select>
											</div>
											<div class="form-group col-md-6">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											<section class="panel">
												<header class="panel-heading"> 新增操作  </header>
												<div class="panel-body">
													<form class="form-horizontal" role="form"
														id="modalForm">
														<div class="form-group">
															<label for="commodityName_editModal"
																class="col-lg-2 col-sm-2 control-label">操作名</label>
															<div class="col-lg-10">
														...
														<div class="form-group">
															<label for="commoditySeq_editModal"
																class="col-lg-2 col-sm-2 control-label">显示样式</label>
															<div class="col-lg-10">
																<input type="text" class="form-control"
																	name="style" id="style"
																	placeholder="显示样式">
														...
														<div class="form-group">
															<label for="commoditySeq_editModal"
																class="col-lg-2 col-sm-2 control-label">作为菜单显示</label>
															<div class="col-lg-10">
