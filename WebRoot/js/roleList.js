...
var commodityListComp = {
	...
	editCommodityClicked : function(id, roleName, roleGrade,
			seqNum) {
		$('#modal_edit #id').val(id);
		$('#modal_edit #roleName').val(roleName);
		$('#modal_edit #roleGrade').val(roleGrade);
		$('#modal_edit #seqNum').val(seqNum);
	},
